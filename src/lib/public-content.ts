  ...
  return records
    .map((record) => {
      ...
      return {
        ...
        group: type,
        type,
        iconUrl: proxiedOssUrl(text(record, "iconUrl")),
        colorIconUrl: proxiedOssUrl(text(record, "colorIconUrl")),
        cardBackgroundColor: text(record, "cardBackgroundColor"),
        cardLogoColor: text(record, "cardLogoColor"),
